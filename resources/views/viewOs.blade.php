                    ...
                    <form id="formOs">
                        ...
                        <div class="form-row" style="display:flex; justify-content: space-between;">
                            ...
                            <div class="form-group col-md-4" style="display: flex; flex-direction: row; align-items: center;">
                                ...
                                <input type="text" class="form-control" id="maquinas" name="maquinas" style="width: 15vw; background-color: #EEE; margin-right:20px;" readonly value="{{ $os->status_name }}">
                            </div>

                            <div class="form-group col-md-4" style="display: flex; flex-direction: row; align-items: center;">
                                <label for="data" style="margin-right: 10px">Data:</label>
                                <input readonly type="text" class="form-control" id="data" name="data" placeholder="Data" value="{{ $data }}" style="margin-right: 20px; background-color: #EEE;">
                            </div>
                            <div class="form-group col-md-4" style="display: flex; flex-direction: row; align-items: center;">
                                <label for="hora" style="margin-right: 10px">Hora:</label>
                                <input readonly style="background-color: #EEE;" type="text" class="form-control" id="hora" name="hora" placeholder="Hora" value="{{ $hora }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row" style="display:flex; justify-content: space-between;">
                            <div class="form-group col-md-6" style="display: flex; flex-direction: row; align-items: center;">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" id="maquinas" name="maquinas" style="width: 35vw; background-color: #EEE;" readonly value="{{ $os->maquina_nome }}">
                                </div>
                            </div>
                            <div class="form-group col-md-6" style="display: flex; flex-direction: row; align-items: center;">
                                <label for="cliente" style="margin-right: 20px">Cliente:</label>
                                <div class="controls">
                                    <input type="text" class="form-control" id="maquinas" name="maquinas" style="width: 35vw; background-color: #EEE;" readonly value="{{ $clientById->nome }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" style="display: flex; justify-content: space-between;">
                            <div class="form-group col-md-6" style="display: flex; flex-direction: row; align-items: center;">
                                ...
                                <input type="text" class="form-control" id="bebidas" name="bebidas" style="width: 35vw; background-color: #EEE;" readonly placeholder="Nº de Bebidas Extraídas" value="{{ $os->bebidas_extraidas }}">
                            </div>
                            <div class="form-group col-md-6" style="display: flex; flex-direction: row; align-items: center;">
                        ...
                        <div class="panel-body panel panel-default" style="padding: 20px 0; display: flex; justify-content: center; border: 1px solid #DDDDDD">
                            <div class="row">
                                ...
                                <div class="form-group" style="margin-left: 6vw; width:70vw; display: flex; justify-content: center; margin-top:10px">
                                    ...
                                    <div class="col-md-10">
                                        <textarea readonly name="obs" style="width:67vw" id="obs" class="form-control" rows="8">{{ $os->obs }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="margin-left: 4vw; width:74vw; display: flex; justify-content: center; margin-top:10px">
                                    ...
                                    <div class="col-md-10" style="width:100%">
                                        <textarea readonly name="descricao_cliente" style="width:98%" id="descricao_cliente" class="form-control" rows="8">{{ $os->descricao_cliente }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div style="margin-top: 50px;">
                            <table style="margin-bottom:40px;" id="tabela" class="table table-bordered">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr id="linha_{{$index+1}}">
                                        <td id="produto_{{$index+1}}">
                                            <input type="text" class="form-control" id="name_{{$index+1}}" name="name_{{$index+1}}" value="{{ $product->produto_nome }}" style="width:27vw; background-color: #EEE" readonly>   
                                        </td>
                                        <td id="rep_{{$index+1}}" name="rep_{{$index+1}}" value="{{ $product->representacao_id }}" style="width: 10vw;">{{ $product->representacao_nome }}</td>
                                        <td style="width: 10vw;">
                                            <input type="number" class="form-control" id="qtd_{{$index+1}}" name="qtd_{{$index+1}}" min="1" onchange="changeTotalById(this)" placeholder="Quant." value="{{ $product->quantidade }}" style="background-color: #EEE" readonly>
                                        </td>
                                        <td style="width: 10vw;">
                                            <input type="number" class="form-control" id="valUnit_{{$index+1}}" name="valUnit_{{$index+1}}" min="1" onchange="changeTotalById(this)" placeholder="Val. Unit." value="{{ $product->valor_unitario }}" style="background-color: #EEE" readonly>
                                        </td>
                        ...
                        <div class="form-group" style=" width:85vw; display: flex; margin-top:10px">
                            ...
                            <div class="col-md-6">
                                <textarea readonly name="avaliacao" style="width:66vw" id="avaliacao" class="form-control" rows="5">{{ $os->avaliacao }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-row" style="display:flex; justify-content: space-between;">
                            <div class="form-group col-md-4" style="display: flex; flex-direction: row; align-items: center;">
                                ...
                                <input readonly type="text" class="form-control" id="dataAvaliacao" name="dataAvaliacao" placeholder="Data de avaliação" value="{{ $dataAvaliacao }}" style="margin-right: 20px; background-color: #EEE;">
                            </div>
                        </div>
