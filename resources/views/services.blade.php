                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="os/visualizar/{{ $r->id }}" style="margin-right: 1%" class="btn tip-top" title="Ver mais detalhes">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="os/editar/{{ $r->id }}" class="btn btn-info tip-top" title="Editar OS">
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%">{{ $r->status_os_id }}</td>
                                        <td style="width:10%">{{ $r->data_avaliacao }}</td>
                                        <td style="width:40%">{{ $r->avaliacao }}</td>
